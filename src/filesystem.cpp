...
void setupFILESYSTEM() {
    String data = "{\"disablesleep\":false, \"wifi\": {\"network\": \"IU PublicNet\", \"enabled\":true}}";
    ...
    data = "[{\"ssid\":\"IU PublicNet\",\"password\":\"\"}, {\"ssid\":\"lol\",\"password\":\"12345678\"}]";
    ...
    "           fs.writeFile(\"/app/\"+e,content.body);\n"
    "       }\n"
    "       refapps();\n"
    "       vibrate();\n"
    "   },\n"
